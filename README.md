...
# 1-Norm of matrix: 
    ...
    2. Find the 1-norm of the matrix using np.linalg.norm(A,1), where A is the matrix
	3. Print the norm of the matrix in two decimal places.

# 2-Norm of matrix:

	1. Get the input matrix using np.array()   
    2. Find the 1-norm of the matrix using np.linalg.norm(a,2),where A is the matrix 
	3. Print the norm of the matrix in two decimal places.

# Infinity Norm of matrix:

	1. Get the input matrix using np.array()   
    2. Find the 1-norm of the matrix using np.linalg.norm(A,np.inf), where A is the matrix
	3. Print the norm of the matrix in two decimal places.
